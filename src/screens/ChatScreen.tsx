...
const AutoMovingRow: React.FC<{
    data: string[];
    onPress: (text: string) => void;

}> = ({ data, onPress, reverse = false }) => {
...
const EmptyState: React.FC<{ onSuggestionPress: (text: string) => void }> = ({ onSuggestionPress }) => {
    ...
    return (
        <View style={styles.emptyContainer}>
            ...
            <Text style={[styles.emptySubtitle, { marginBottom: 10 }]}>
                or type what happened to your dog in the message bar
            </Text>
