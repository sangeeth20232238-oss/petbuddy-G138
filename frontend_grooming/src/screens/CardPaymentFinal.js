      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.card}>
          <View style={styles.cardRow}>
            ...
            <Ionicons name="checkmark-circle" size={22} color="#FF741C" />
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  rowLabel: { fontSize: 14, color: '#444444' },
  rowValue: { fontSize: 14, fontWeight: '600', color: '#000000' },
  cardRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 16, gap: 14 },
  cardIconBox: { flexDirection: 'row', width: 44 },
  brandCircle1: { width: 26, height: 26, borderRadius: 13, backgroundColor: '#FF741C' },
  brandCircle2: { width: 26, height: 26, borderRadius: 13, backgroundColor: '#FF741C', marginLeft: -10, opacity: 0.85 },
  cardInfo: { flex: 1 },
  cardBank: { fontSize: 14, fontWeight: '700', color: '#000000' },
  cardMasked: { fontSize: 12, color: '#666666', marginTop: 2 },
  ...
  totalLabel: { fontSize: 15, fontWeight: 'bold', color: '#000000' },
  totalValue: { fontSize: 16, fontWeight: 'bold', color: '#FF741C' },
  payBtn: { backgroundColor: '#FF741C', borderRadius: 14, paddingVertical: 16, alignItems: 'center' },
