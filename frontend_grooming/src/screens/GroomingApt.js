...
const styles = StyleSheet.create({
  ...
  detailIconBox: { width: 34, height: 34, borderRadius: 10, backgroundColor: '#D4D4D4', justifyContent: 'center', alignItems: 'center' },
  detailText: { flex: 1 },
  ...
  serviceIconBox: { width: 30, height: 30, borderRadius: 8, backgroundColor: '#D4D4D4', justifyContent: 'center', alignItems: 'center' },
  ...
  modalIconBox: { width: 56, height: 56, borderRadius: 28, backgroundColor: '#D4D4D4', justifyContent: 'center', alignItems: 'center', marginBottom: 14 },
  ...
  navBtn: { width: 30, height: 30, borderRadius: 8, backgroundColor: '#D4D4D4', justifyContent: 'center', alignItems: 'center' },
  ...
  reasonIconBox: { width: 30, height: 30, borderRadius: 8, backgroundColor: '#D4D4D4', justifyContent: 'center', alignItems: 'center' },
  ...
  inputIconBox: { width: 34, height: 34, borderRadius: 10, backgroundColor: '#D4D4D4', justifyContent: 'center', alignItems: 'center' },
